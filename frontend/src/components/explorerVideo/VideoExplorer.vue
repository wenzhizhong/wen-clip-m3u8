...
const emit = defineEmits<{
  ...
  'focus-change': [index: number, item: PlayPathListInterface]
  'item-activate': [index: number, item: PlayPathListInterface]
}>()
...
const exposeMethods: FileExplorerExpose = {
  ...
  getSelectedIds: () => {
    return selectedItems.value.map(item => item.data.name)
  },
